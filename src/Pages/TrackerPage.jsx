...
const BENCHMARKS = [
  { label: 'World Avg', value: 4.0, color: 'bg-green-400' },
  { label: 'EU Avg', value: 8.0, color: 'bg-amber-400' },
  { label: 'US Avg', value: 14.5, color: 'bg-orange-400' },
];
...
export default function TrackerPage() {
  ...
  const set = (key) => (e) => setVals((v) => ({ ...v, [key]: e.target.type === 'number' ? Number(e.target.value) : e.target.value }));
  ...
  const results = useMemo(() => {
    ...
    const energy =
      vals.electricity * 12 * EMIT.electricity +
      vals.naturalGas * 12 * EMIT.naturalGas;
      ...
      <div className="section-container py-12">
        <div className="mb-10">
          ...
          <p className="text-stone-500 mt-2 max-w-xl">
            Estimate your personal carbon emissions based on lifestyle inputs. Results update in real time.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className={SELECT} value={vals.carType} onChange={set('carType')}>
                ...
                <div>
                  ...
                  <input type="number" className={INPUT} min="0" step="500" value={vals.carMiles} onChange={set('carMiles')} />
                </div>
              </div>
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={key}>
                      ...
                      <input type="number" className={INPUT} min="0" max="50" value={vals[key]} onChange={set(key)} />
            ...
            <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className={LABEL}>Electricity (kWh/month)</label>
                  <input type="number" className={INPUT} min="0" step="50" value={vals.electricity} onChange={set('electricity')} />
                  <p className="text-xs text-stone-400 mt-1">US avg: ~900 kWh/month</p>
                </div>
                <div>
                  <label className={LABEL}>Natural gas (therms/month)</label>
                  <input type="number" className={INPUT} min="0" step="5" value={vals.naturalGas} onChange={set('naturalGas')} />
                  <p className="text-xs text-stone-400 mt-1">0 if electric only</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  >
                    <input type="radio" name="diet" value={value} checked={vals.diet === value} onChange={set('diet')} className="mt-0.5 accent-green-600" />
                    <div>
              ...
              <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6">
                ...
                <div className="border-t border-stone-100 pt-5">
                  ...
                  <div className="space-y-3">
                    {[...BENCHMARKS, { label: 'You', value: results.total, color: `bg-[${level.color}]` }].map(({ label, value }) => (
                ...
                <div className="space-y-4">
                  {tips.map((tip, i) => (
                    <div key={i} className="flex gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-green-900" dangerouslySetInnerHTML={{ __html: tip.title }} />
        ...
        <p className="text-xs text-stone-400 text-center mt-10">
          Emission factors from EPA, IPCC, and Our World in Data. Results are estimates for educational purposes.
        </p>
      </div>
    </div>
  );
